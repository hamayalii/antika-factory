        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-[15.5px] sm:text-[16.5px] text-gray-600 leading-relaxed font-light">
              بەرهەمهێنانی خانووی حاویە، خانووی ئاسایی، خانووی باخچە، و خانووی کوخی دوو قات بە ستانداردی بەرز و کەرەستەی خۆڕاگر لە کارگەی ئەنتیکا فاکتۆری بۆ باخ، کێڵگە،یەکە نیشتەجێبوون و پڕۆژە تایبەتەکان.
            </p>
          </Reveal>
        </div>
      </section>
